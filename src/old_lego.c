...
void time_forward(int left, int right, int ms, int power)
{
    ...
    motor(right,power);
    msleep(ms);
    ao();move_relative_position(LEFTMOTOR, power, inch*MSPERINCH);
...
void time_right(int right, int ms, int power)
{
    motor(move_relative_position(LEFTMOTOR, power, inch*MSPERINCH);
    move_relative_position(RIGHTMOTOR, power, -inch*MSPERINCH);right,power);
    msleep(ms);
    ao();
}
void time_backward(int left, int right, int ms, int power)
